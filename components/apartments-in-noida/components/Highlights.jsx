...
const highlights = [
  {
    text: 'Exclusive Living: Only 3 Towers | 288 Exclusive Residences',
    icon: <Trophy {...highlightIconProps} />,
  },
  {
    text: 'Breathtaking Views: Breathtaking Golf Course & Green Views',
    icon: <Trees {...highlightIconProps} />,
  },
  {
    text: 'Low Density: Ultra-Low Density Development',
    icon: <Waves {...highlightIconProps} />,
  },
  {
    text: 'Superior Ventilation: East-West Oriented Homes for Superior Light & Ventilation',
    icon: <HeartPulse {...highlightIconProps} />,
  },
  {
    text: 'Premium Township: Located within a 100-Acre Premium Golf Township',
    icon: <Dumbbell {...highlightIconProps} />,
  },
  {
    text: 'Daily Conveniences: Luxury Retail & Daily Conveniences Within Walking Distance',
    ...
    <div className="container mx-auto px-4 md:px-8">
      ...
      <div style={{ textAlign: 'center', marginBottom: '40px' }} data-aos="fade-up">
        <span style={{
          ...
          }}>Greater Noida Yamuna Expressway</span>
        <h2 style={{
          fontFamily: F_JOST, fontWeight: '800', fontSize: '26px',
          color: '#111827', margin: 0, letterSpacing: '-0.01em',
        }}>
          Project Highlights:{' '}
          <span style={{ color: 'var(--color-gold)' }}>Godrej Crown Residences</span>
        </h2>
