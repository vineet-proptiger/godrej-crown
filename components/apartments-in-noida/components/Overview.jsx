...
import { overviewImage } from '../../../lib/apartments-in-noida/images'
      ...
      <div className="container mx-auto px-4 md:px-8">
        ...
        <div style={{ textAlign: 'center', marginBottom: '36px' }} data-aos="fade-up">
          ...
          <h2 style={{
            ...
            Godrej Crown Residences <span style={{ color: 'var(--color-gold)' }}>Overview</span>
          </h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 items-stretch">
          ...
          <div data-aos="fade-right" style={{ display: 'flex', alignItems: 'center' }}>
            ...
            >
              <Image src={overviewImage} alt="Godrej Crown Residences Overview" width={800} height={1200} className="w-full h-auto" priority />
              {/* <div style={{
