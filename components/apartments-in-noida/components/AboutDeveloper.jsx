...
import { PROJECT_ID, PROJECT_NAME, API_ENDPOINT, SHEET_NAME, SECRET_KEY, CITY_DISPLAY } from '../../../lib/apartments-in-noida/config'
import { buildTrackingFields } from '../../../lib/apartments-in-noida/formMeta'
  ...
  <section id="developer" className="py-10 sm:py-14 bg-[var(--color-bg-muted)] border-b border-gray-100">
    <div className="container mx-auto px-4 md:px-8">
      ...
      <div className="text-center mb-10" data-aos="fade-up">
        ...
        }}>Godrej Group — Developer Profile</span>
        <h2 style={{
        ...
        <div style={{
          ...
          <div style={{ padding: '24px 28px', flex: 1, display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
            <p style={{ color: '#555', fontFamily: F_SANS, lineHeight: 1.85, fontSize: '14px', margin: '0 0 14px', textAlign: 'justify' }}>
              Established in 1897, the Godrej Group has its roots in India's Independence and Swadeshi movement. Our founder, Ardeshir Godrej, a lawyer-turned-serial entrepreneur struck gold with a locks business. Today, we enjoy the patronage of 1.1 billion consumers globally across consumer goods, real estate, appliances, agriculture and many other businesses. In fact, our geographical footprint extends beyond Earth, with our engines now powering many of India's space missions. With a revenue of over USD 6 billion, we are growing fast, and have exciting, ambitious aspirations.</p>
