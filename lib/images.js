...
export const galleryImages = [
  { src: '/images/gallery/front elevation.webp', alt: 'Godrej Crown Residences — Front Elevation' },
  { src: '/images/gallery/fron elevation.webp', alt: 'Godrej Crown Residences — Elevation View' },
  { src: '/images/gallery/clubhouse.webp', alt: 'Godrej Crown Residences — Club House' },
  // { src: '/images/gallery/banner.webp', alt: 'Godrej Crown Residences — Luxury Apartments' },
  { src: '/images/gallery/banner2.webp', alt: 'Godrej Crown Residences — Premium Residences' },
]
