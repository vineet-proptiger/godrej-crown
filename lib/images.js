// ═══════════════════════════════════════════════════════════════
//  CENTRAL IMAGE CONFIG — Godrej Crown Residences (Gurugram)
// ═══════════════════════════════════════════════════════════════
...
// ── Highlights ────────────────────────────────────────────────
export const highlightsImage = '/images/highlights/highlights.webp'
...
export const galleryImages = [
  { src: '/images/gallery/g1.webp', alt: 'Godrej Crown Residences — Gallery 1' },
  { src: '/images/gallery/g2.webp', alt: 'Godrej Crown Residences — Gallery 2' },
  { src: '/images/gallery/g3.webp', alt: 'Godrej Crown Residences — Gallery 3' },
  { src: '/images/gallery/g4.webp', alt: 'Godrej Crown Residences — Gallery 4' },
  { src: '/images/gallery/g5.webp', alt: 'Godrej Crown Residences — Gallery 5' },
  { src: '/images/gallery/g6.webp', alt: 'Godrej Crown Residences — Gallery 6' },
]
...
export const faviconImages = {
  ...
  icon: [
    { url: '/images/godrej favicon.png', type: 'image/png' },
  ],
  apple: [{ url: '/images/godrej favicon.png', sizes: '180x180', type: 'image/png' }],
  android: [
    { src: '/images/godrej favicon.png', sizes: '192x192', type: 'image/png' },
    { src: '/images/godrej favicon.png', sizes: '512x512', type: 'image/png' },
  ],
}
